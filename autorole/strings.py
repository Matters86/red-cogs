...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "panel_emoji_dropped": "⚠️ Discord hat mindestens ein Emoji abgelehnt – das Panel wurde ohne Emojis gepostet. Bitte die Emojis der Rollen prüfen.",
    ...
    "en": {
        ...
        "panel_emoji_dropped": "⚠️ Discord rejected at least one emoji – the panel was posted without emojis. Please check the role emojis.",
