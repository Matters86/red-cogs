...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "hp_warn_edited": "Warnnachricht im Honeypot-Kanal {channel} aktualisiert.",
        "hp_warn_posted": "Warnnachricht im Honeypot-Kanal {channel} neu gepostet.",
        "hp_warn_saved": "Warntext gespeichert.",
        "hp_warn_no_channel": "Kein Honeypot-Kanal gesetzt oder der Kanal existiert nicht mehr – Warnnachricht nicht aktualisiert.",
        "hp_warn_forbidden": "Mir fehlen Rechte im Honeypot-Kanal {channel} (Nachrichten senden / Verlauf lesen) – Warnnachricht nicht aktualisiert.",
        "hp_warn_failed": "Die Warnnachricht im Honeypot-Kanal {channel} konnte nicht aktualisiert werden (Discord-Fehler).",
    ...
    "en": {
        ...
        "hp_warn_edited": "Warning message in honeypot channel {channel} updated.",
        "hp_warn_posted": "Warning message in honeypot channel {channel} posted anew.",
        "hp_warn_saved": "Warning text saved.",
        "hp_warn_no_channel": "No honeypot channel set or the channel no longer exists – warning message not updated.",
        "hp_warn_forbidden": "I lack permissions in honeypot channel {channel} (send messages / read history) – warning message not updated.",
        "hp_warn_failed": "The warning message in honeypot channel {channel} could not be updated (Discord error).",
